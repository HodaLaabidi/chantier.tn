...
public class ViewPagerIndicator extends LinearLayoutCompat {
    ...
    private static final float NO_SCALE = 6f;
    ...
    private int mItemSelectedColor = R.color.colorYellow;
    ...
    public ViewPagerIndicator(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        ...
        try {
            ...
            mItemSelectedColor =R.color.colorYellow;
            mItemColor = R.color.colorYellow;
    ...
    private void setSelectedIndex(final int selectedIndex) {
        ...
        unselectedView.animate().scaleX(4f).scaleY(4f).setDuration(300).start();
        //unselectedView.setColorFilter(R.color.colorBlack, android.graphics.PorterDuff.Mode.SRC_IN);
        ...
        //selectedView.setColorFilter(R.color.colorYellow, android.graphics.PorterDuff.Mode.SRC_IN);
    ...
    private ImageView createItem() {
        ...
        index.setColorFilter(R.color.colorBlack, android.graphics.PorterDuff.Mode.SRC_IN);
        return index;
    }
